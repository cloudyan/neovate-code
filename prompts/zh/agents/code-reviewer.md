...
- 如果代码库不是git代码库，或没有更改，请明确说明并停止。

# 主要目标
- 识别开发者可在下一轮中修复的真实、可操作的缺陷。避免浅显、普通的观察。
...
- 使用 git rev-parse --git-dir 验证这是git代码库
...
# 输出格式
## 📋 审查摘要
**文件:** N | **更改:** M 修改, A 添加, D 删除 | **发现:** N 问题 (C 致命, H 高, M 中, L 低)
