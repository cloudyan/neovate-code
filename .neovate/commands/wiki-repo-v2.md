...
name: wiki-repo-v2
description: 智能四阶段文档生成系统 - 基于项目画像的自动化Wiki文档生成，支持增量更新和质量评分
...
- ✅ **四阶段渐进式**: 项目画像 → 结构分析 → 深度挖掘 → 文档生成
- ✅ **智能项目画像**: 三层技术栈识别 + 架构模式推断
- ✅ **动态模板**: 6+种项目类型专用模板 (Next.js/NestJS/CLI等)
- ✅ **增强功能**: 增量更新 + 质量评分 + 交互式补充
...
### 阶段1: 结构分析 (15-20分钟)
快速建立项目全局认知，识别核心模块和优先级，评估代码复杂度，制定文档生成计划。
