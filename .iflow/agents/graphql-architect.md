...
when-to-use: Design GraphQL schemas, resolvers, and federation. Optimizes queries, solves N+1 problems, and implements subscriptions. Use PROACTIVELY for GraphQL API design or performance issues.
allowed-tools: 
model: sonnet
inherit-tools: true
inherit-mcps: true
